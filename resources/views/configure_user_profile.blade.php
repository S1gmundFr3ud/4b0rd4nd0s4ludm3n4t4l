@extends('layouts.main', ['activePage' => 'porfile', 'titlePage' => 'Mi Perfil'])
      ...
      <div class="col-md-8">
        <form action="{{route('changePassword')}}" method="POST" class="needs-validation" novalidate>
            ...
            <div class="row mb-3">
              ...
              {{-- <span>{{ Auth::user()->user_postulados_relacions()->edad }}</span> --}}
                           <h3><b>{{ Auth::user()->id }}</b> </h3>
            ...
            <div class="row text-center mb-4 mt-5">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-info" id="formSubmit">Guardar Cambios</button>
