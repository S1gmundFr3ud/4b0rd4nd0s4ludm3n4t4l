      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-info">
            <h4 class="card-title">Acompañantes Terapeuticos del Gran Buenos Aires</h4>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12 text-right">
                ...
                <a href="{{ route('card.create')}}" class="btn btn-sm btn-facebook">Añadir</a>
                                  ...
                                  <center>
                                    <h5 class="card-title profession">{{ $item->user->name }}</h5>
                                      ...
                                      <div class="name-profession">
                                        <span class="profession">Acompañante Terapeutico</span>
