@extends('layouts.main', ['activePage' => 'card', 'titlePage' => 'Nuevo Acompañante'])
@section('content')
               ...
               <div class="container-dluid">
                <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="user_id" placeholder="" value="  {{ old('user_id', Auth::user()->id)}} " autofocus>
